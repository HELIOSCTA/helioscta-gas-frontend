...
export const WORKSPACE_ONBOARDING_ENABLED = envBool("NEXT_PUBLIC_WORKSPACE_ONBOARDING_ENABLED", true);
export const RUN_DIFF_ENABLED = envBool("NEXT_PUBLIC_RUN_DIFF_ENABLED", true);
export const DATASET_DISCOVERY_ENABLED = envBool("NEXT_PUBLIC_DATASET_DISCOVERY_ENABLED", true);
